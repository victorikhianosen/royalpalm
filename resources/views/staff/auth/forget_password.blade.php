<x-auth>
    <section class="">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 w-screen h-screen items-center bg-softGrey">
            <img class="hidden lg:block w-screen h-screen" src="{{ asset('assets/images/home/price3.jpeg') }}" alt="">

            <div class="px-10 space-y-12 lg:space-y-24">
                <div class="text-center space-y-8">
                    <h2 class="text-3xl font-bold lg:text-4xl tracking-wider text-primary">Forget Password</h2>
                ...
                <div>
                    <form action="" class="space-y-6">
                        <div class="">
                            <input class="w-full focus:outline-none text-primary border-2
                        ...
                        <div class="pt-4">
                            <button
                                class="text-lg lg:text-xl font-semibold bg-primary hover:bg-hoverPrimary text-white px-12 py-4 tracking-wider">
                                Submit
                            </button>
                        </div>
                    </form>
                    ...
                    <div class=" flex justify-between">
                        ...
                        <div
                            class="mt-8 uppercase text-xs text-primary font-extralight transition-all duration-1000 hover:text-hoverPrimary  hover:-translate-x-5">
                            <a href="{{ route("staff_register") }}">Register</a>
                        </div>
                    </div>
