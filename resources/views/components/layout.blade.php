...
<body>
    ...
    <nav id="main-nav" class="relative sticky top-0 right-0 left-0 bg-white z-10">
        <div class="mx-auto p-6 py-4 md:py-6 px-6 md:px-16">
            <div class="flex justify-between items-center">
                ...
                <div class="space-x-10 hidden md:inline-block">
                    ...
                    <a href=""
                        class="bg-primary py-3 px-6 text-white rounded-lg hover:bg-hoverPrimary">Login</a>
                </div>
            </div>
        </div>
        ...
        <button id="nav-close"
            class="hidden md:hidden absolute top-4 right-2 transition-opacity duration-300 opacity-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-10 h-10 text-primary">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="space-y-16 mt-16 px-12 text-primary cursor-pointer">
                <a href="{{ route('home') }}" alt="">
                    ...
                    <div class="flex flex-col space-y-10">
                        ...
                        <span>
                            <a class="transition-all duration-150 hover:text-hoverPrimary" href="{{ route('about') }}">About</a>

                        </span>
                        <span>
                            <a class="transition-all duration-150 hover:text-hoverPrimary" href="{{ route('gallery') }}">Gallery</a>
                        ...
                        <span>
                            <a class="transition-all duration-150 hover:text-hoverPrimary" href="{{ route('contact') }}">Contact</a>
